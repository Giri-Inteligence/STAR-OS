...
st.markdown("""
    ...
    /* BOTÃO TRANSPARENTE SOBREPOSTO AO CARD - SEM RÓTULOS */
    .stButton button {
...
with st.sidebar:
    ...
    st.markdown("---")
    st.caption("v5.3 | Hub Estratégico")
...
with cols[0]:
    ...
    if st.button("", key="btn_star"): # Botão agora é uma camada invisível sem texto
...
with cols[2]:
    st.markdown('<div class="tool-card"><h4>⚙️ Arquitetura Comercial</h4><p>Estruturação de Processos e Playbooks</p></div>', unsafe_allow_html=True)
